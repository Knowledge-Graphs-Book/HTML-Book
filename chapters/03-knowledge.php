	<section id="chap-knowledge" class="chapter">
		...
		<p>Two shapes languages have recently emerged for RDF graphs: <em>Shape Expressions</em> (<em>ShEx</em>), published as a W3C Community Group Report&nbsp;<? echo $references->cite("Prudhommeaux2014"); ?>; and <em>SHACL</em> (<em>Shapes Constraint Language</em>), published as a W3C Recommendation&nbsp;<? echo $references->cite("SHACLSpec"); ?>. These languages support the discussed features (and more) and have been adopted for validating graphs in a number of domains relating to healthcare&nbsp;<? echo $references->cite("ThorntonSSGMPW19"); ?>, scientific literature&nbsp;<? echo $references->cite("HammondPT17"); ?>, spatial data&nbsp;<? echo $references->cite("Car2019"); ?>, amongst others. More details about ShEx and SHACL can be found in the book by <? echo $references->citet("Labra2017"); ?>. A recently proposed language that can be used as a common basis for both ShEx and SHACL reveals their similarities and differences&nbsp;<? echo $references->cite("Labra-Gayo2019"); ?>. A similar notion of schema has been proposed by <? echo $references->citet("Angles18"); ?> for property graphs.</p>
