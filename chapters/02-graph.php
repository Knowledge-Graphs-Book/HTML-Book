		...
		<div class="formal">
			...
			<div class="example">
				...
				<ul>
					...
					<li>the mapping \(p\) gives, for example, \(p(\)<code>LA380</code>\() =\{ (\)<code>company</code>, <code>LATAM</code>\() \}\) and \(p(\)<code>Santiago</code>\() =\)<span style="white-space:nowrap;">\(\{ (\)<code>lat</code>, <code>–33.45</code>\(), (\)<code>long</code>, <code>–70.66</code>\() \}\).</li>
				</ul>
			</div>
